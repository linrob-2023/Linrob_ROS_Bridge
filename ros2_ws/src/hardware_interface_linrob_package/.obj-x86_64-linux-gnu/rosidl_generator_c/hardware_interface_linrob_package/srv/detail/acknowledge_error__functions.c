...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__create()
{
  ...
  hardware_interface_linrob_package__srv__AcknowledgeError_Request * msg = (hardware_interface_linrob_package__srv__AcknowledgeError_Request *)allocator.allocate(sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Request));
  bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Request__init(msg);
  if (!success) {
...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__destroy(hardware_interface_linrob_package__srv__AcknowledgeError_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    hardware_interface_linrob_package__srv__AcknowledgeError_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__init(hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hardware_interface_linrob_package__srv__AcknowledgeError_Request * data = NULL;

  if (size) {
    data = (hardware_interface_linrob_package__srv__AcknowledgeError_Request *)allocator.zero_allocate(size, sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        hardware_interface_linrob_package__srv__AcknowledgeError_Request__fini(&data[i - 1]);
      }
...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__fini(hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      hardware_interface_linrob_package__srv__AcknowledgeError_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * array = (hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence *)allocator.allocate(sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__init(array, size);
  if (!success) {
...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__destroy(hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence__are_equal(const hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * lhs, const hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hardware_interface_linrob_package__srv__AcknowledgeError_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hardware_interface_linrob_package__srv__AcknowledgeError_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hardware_interface_linrob_package__srv__AcknowledgeError_Request * data =
      (hardware_interface_linrob_package__srv__AcknowledgeError_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hardware_interface_linrob_package__srv__AcknowledgeError_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hardware_interface_linrob_package__srv__AcknowledgeError_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!hardware_interface_linrob_package__srv__AcknowledgeError_Request__copy(
...
hardware_interface_linrob_package__srv__AcknowledgeError_Response__init(hardware_interface_linrob_package__srv__AcknowledgeError_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    hardware_interface_linrob_package__srv__AcknowledgeError_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hardware_interface_linrob_package__srv__AcknowledgeError_Response * msg = (hardware_interface_linrob_package__srv__AcknowledgeError_Response *)allocator.allocate(sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Response));
  bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__init(hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hardware_interface_linrob_package__srv__AcknowledgeError_Response * data = NULL;

  if (size) {
    data = (hardware_interface_linrob_package__srv__AcknowledgeError_Response *)allocator.zero_allocate(size, sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        hardware_interface_linrob_package__srv__AcknowledgeError_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__fini(hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      hardware_interface_linrob_package__srv__AcknowledgeError_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * array = (hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence *)allocator.allocate(sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__destroy(hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence__are_equal(const hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * lhs, const hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!hardware_interface_linrob_package__srv__AcknowledgeError_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  hardware_interface_linrob_package__srv__AcknowledgeError_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(hardware_interface_linrob_package__srv__AcknowledgeError_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    hardware_interface_linrob_package__srv__AcknowledgeError_Response * data =
      (hardware_interface_linrob_package__srv__AcknowledgeError_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!hardware_interface_linrob_package__srv__AcknowledgeError_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          hardware_interface_linrob_package__srv__AcknowledgeError_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!hardware_interface_linrob_package__srv__AcknowledgeError_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
