...
#include "hardware_interface_linrob_package/srv/detail/init__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hardware_interface_linrob_package::srv::Init_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hardware_interface_linrob_package::srv::Init_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hardware_interface_linrob_package::srv::Init_Request *>(
    untyped_ros_message);
...
{
  return &hardware_interface_linrob_package::srv::typesupport_fastrtps_cpp::_Init_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = hardware_interface_linrob_package::srv::Init_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hardware_interface_linrob_package::srv::Init_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<hardware_interface_linrob_package::srv::Init_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &hardware_interface_linrob_package::srv::typesupport_fastrtps_cpp::_Init_Response__handle;
}
...
{
  return &hardware_interface_linrob_package::srv::typesupport_fastrtps_cpp::_Init__handle;
}
