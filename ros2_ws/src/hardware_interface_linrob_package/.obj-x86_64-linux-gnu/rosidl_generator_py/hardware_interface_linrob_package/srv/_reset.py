...
class Metaclass_Reset(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hardware_interface_linrob_package.srv.Reset')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from hardware_interface_linrob_package.srv import _reset
...
class Reset(metaclass=Metaclass_Reset):
    from hardware_interface_linrob_package.srv._reset import Reset_Request as Request
    from hardware_interface_linrob_package.srv._reset import Reset_Response as Response
